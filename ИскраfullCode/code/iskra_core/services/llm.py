    ...
    async def generate_response(
        ...
        try:
            ...
            impact_map = {
                ...
                # Transitional facet contributes to navigation between states.
                FacetType.SIBYL: "transition",
                # Bloom facet marks consolidation and celebration of growth.
                FacetType.MAKI: "bloom",
            }
...
async def _generate_special_response(
    ...
    async def generate_response(
        ...
        Handles canonical triggers (Manta/Shadow) then runs a ReAct loop
        to select and invoke tools, finishes with a final response and
        logs the result.
        """
