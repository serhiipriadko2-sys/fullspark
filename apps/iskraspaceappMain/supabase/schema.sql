...
CREATE TABLE IF NOT EXISTS memory_nodes (
    ...
    tags TEXT[] DEFAULT '{}',
    section TEXT,
    facet TEXT CHECK (facet IN ('KAIN', 'PINO', 'SAM', 'ANHANTRA', 'HUNDUN', 'ISKRIV', 'ISKRA', 'MAKI', 'SIBYL')),
    evidence JSONB,
    created_at TIMESTAMPTZ DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS voice_preferences (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    voice_name TEXT NOT NULL CHECK (voice_name IN ('KAIN', 'PINO', 'SAM', 'ANHANTRA', 'HUNDUN', 'ISKRIV', 'ISKRA', 'MAKI', 'SIBYL')),
...
CREATE TABLE IF NOT EXISTS chat_history (
    ...
    text TEXT NOT NULL,
    voice_name TEXT CHECK (voice_name IN ('KAIN', 'PINO', 'SAM', 'ANHANTRA', 'HUNDUN', 'ISKRIV', 'ISKRA', 'MAKI', 'SIBYL')),
